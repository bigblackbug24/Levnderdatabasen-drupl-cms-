<?php
	...
	<div class="header">
		<div class="top-bar">
			<div class="container">
				<div class="header-wdget">
					<div class="kr-mobile-sticky"></div>
					<!--<a class="nav-search" href="/kommunaldata"></a>-->
					<a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" class="logo">
						<img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" />
						<img src="<?php echo $base_url.'/'.$themePath.'/images/leverandordatabasen_dt_sticky_1x.svg' ?>" class="sticky-logo" alt="">
						<img src="<?php echo $base_url.'/'.$themePath.'/images/leverandordatabasen_mobil_sticky_1x.svg' ?>" class="mobile-sticky-logo" alt="">
		...
		<div class="container sub-header">
			<a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" ><img src="<?php echo $base_url.'/'.$themePath.'/images/leverandordatabasen_dt_stor_1x.svg' ?>" class="stor-logo" alt=""></a>
		</div>		
