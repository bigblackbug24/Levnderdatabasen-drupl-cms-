...
if (substr("cross_promotion_official_information", $url_string) || substr("cross_promotion_main_industries", $url_string) || 
        substr("cross_promotion_municipal_council_piechart", $url_string) || substr("cross_promotion_suppliers", $url_string) || 
        substr("cross_promotion_summary", $url_string)) {
...
?>
	...
	<?php if(drupal_is_front_page()) { ?>
		<?php global $base_url; global $user; global $role;?>
