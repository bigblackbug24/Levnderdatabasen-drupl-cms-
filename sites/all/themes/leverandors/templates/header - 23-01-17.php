<?php
	...
	<header class="header">
		<div class="top-bar">
			<div class="container">
				<div class="header-wdget clearfix">
					<a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" class="logo">
						<img class="kr-mobile-logo" src="<?php echo $base_url.'/'.$themePath.'/images/kr_mobil_sticky_1x.svg' ?>" alt="Kommunal Rapport logo">
						<img class="header-title" src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" />
						<span class="header-title-alt">Leverandørdatabasen</span>
					</a>
